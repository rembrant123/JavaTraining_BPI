...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (MINIMUM_INITIAL_BALANCE > initialBalance) {
			...
			String format = String.format("Minimum Balance: ₱%.2f, Received Balance: ₱%.2f",MINIMUM_INITIAL_BALANCE,initialBalance);
			throw new InvalidAccountException(format);
		}
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (amount <= 0) {
			...
			throw new InvalidTransferException(String.format("Transfer amount must be positive. Received: P%.2f",amount));
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(String.format("Current Balance: ₱%.2f, Reuired Amount: ₱%.2f",fromAccount.getBalance(),amount));
		}
